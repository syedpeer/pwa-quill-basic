class PWAConfApp {
  ...
  async loadSpeakers() {
    this.speakers = await this.fetchJSON('./data/speakers.json');
  ...
  async loadSchedule() {
    const rawSchedule = await this.fetchJSON('./data/schedule.json');
    ...
    return `
      <div class="schedule-item ${scheduleItem.category}">
        <div class="title-and-time">
          <div class="time">${scheduleItem.startDate}</div>
